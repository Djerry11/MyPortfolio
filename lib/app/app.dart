import 'package:my_portfolio/services/local/project_service.dart';
import 'package:my_portfolio/services/network/url_launcher_service.dart';
import 'package:my_portfolio/ui/dialogs/project_details/project_details_dialog.dart';
import 'package:my_portfolio/ui/views/contact_view/contactview.dart';

import 'package:my_portfolio/ui/views/main_view/main_view.dart';
import 'package:my_portfolio/ui/views/splash_view/splash_view.dart';

import 'package:my_portfolio/ui/views/unknown_view/unknown_view.dart';
...
@StackedApp(
  routes: [
    ...
    CustomRoute(page: MainView, children: [
