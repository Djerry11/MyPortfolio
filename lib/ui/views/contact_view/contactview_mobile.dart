...
import 'package:my_portfolio/viewmodels/contact_viewmodel/contact_viewmodel.dart';
      ...
      children: [
        ...
        CarouselSlider.builder(
          ...
          itemBuilder: (context, index, realIndex) {
            return ContactCard(
                icon: AppConstants.contactList[index]['icon'],
                hoverIcon: AppConstants.contactList[index]['hoverIcon'],
                title: AppConstants.contactList[index]['title'],
                subTitle: AppConstants.contactList[index]['subTitle']);
          },
