...
import 'package:my_portfolio/ui/views/main_view/widgets/drawer_mobile.dart';
import 'package:my_portfolio/ui/views/main_view/widgets/navbar.dart';
  ...
  Widget builder(BuildContext context, MainViewModel viewModel, Widget? child) {
    ...
    return Scaffold(
      ...
      drawer: ScreenTypeLayout.builder(
        mobile: (_) =>
            DrawerMobile(onItemTapped: (p0) => viewModel.onItemTapped(p0)),
        desktop: (_) {
          WidgetsBinding.instance.addPostFrameCallback(
              (_) => viewModel.scaffoldKey.currentState!.closeDrawer());
          return Container();
        },
      ),
      body: SafeArea(
        ...
        children: [
          ...
          ScreenTypeLayout.builder(
            ...
            desktop: (_) =>
                NavbarDesktop(onItemTapped: (p0) => viewModel.onItemTapped(p0)),
          ),
        ],
      )),
    );
