...
import 'package:my_portfolio/app/app.locator.dart';
...
class SocialIconsBtn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...AppConstants.socialIcons.map((e) => IconButton(
              icon: e,
              hoverColor: AppColors.hoverColor,
              splashColor: AppColors.splashColor,
              highlightColor: AppColors.highlightColor,
              iconSize: getValueForScreenType(
                  context: context, desktop: 28, tablet: 24, mobile: 22),
              isSelected: true,
              padding: const EdgeInsets.all(15),
              onPressed: () {
                urllauncherservice.launchInBrowser(AppConstants
                    .socialLinks[AppConstants.socialIcons.indexOf(e)]);
              },
            ).scaleOnHover())
      ],
    );
