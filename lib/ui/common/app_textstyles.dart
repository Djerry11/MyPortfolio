...
class AppTextStyles {
  ...
  static init(BuildContext context) {
    ...
    const baseStyle =
        TextStyle(fontFamily: 'Poppins', color: AppColors.textColor);

    h1 = baseStyle.copyWith(
        fontSize: getValueForScreenType(
            context: context, desktop: 22, tablet: 20, mobile: 18));
    h1b = h1!.copyWith(fontWeight: b);

    h2 = baseStyle.copyWith(
        fontSize: getValueForScreenType(
            context: context, desktop: 18, tablet: 16, mobile: 13));
    h2b = h2!.copyWith(fontWeight: b);

    h3 = baseStyle.copyWith(
        fontSize: getValueForScreenType(
            context: context, desktop: 16, tablet: 13, mobile: 12));
    h3b = h3!.copyWith(fontWeight: b);

    titleHeading1 = baseStyle.copyWith(
      fontSize: getValueForScreenType(
          context: context, desktop: 80, tablet: 50, mobile: 40),
    ...
    titleHeading2 = baseStyle.copyWith(
        ...
        height: 1);
    mainHeading = h1?.copyWith(
        fontFamily: 'Montserrat',
        fontSize: getValueForScreenType(
            context: context, desktop: 35, tablet: 30, mobile: 25));
    subHeading = l1?.copyWith(
        fontFamily: 'Montserrat',
        color: Colors.white,
        fontSize: getValueForScreenType(
            context: context, desktop: 14, tablet: 12, mobile: 10));

    b1 = baseStyle.copyWith(
        fontSize: getValueForScreenType(
            context: context, desktop: 10, tablet: 8, mobile: 6));
    b1b = b1!.copyWith(fontWeight: b);

    b2 = baseStyle.copyWith(
        fontSize: getValueForScreenType(
            context: context, desktop: 8, tablet: 6, mobile: 5));
    b2b = b2!.copyWith(fontWeight: b);

    l1 = baseStyle.copyWith(
        fontSize: getValueForScreenType(
            context: context, desktop: 6, tablet: 5, mobile: 4));
    l1b = l1!.copyWith(fontWeight: b);

    l2 = baseStyle.copyWith(
        fontSize: getValueForScreenType(
            context: context, desktop: 5, tablet: 4, mobile: 3));
