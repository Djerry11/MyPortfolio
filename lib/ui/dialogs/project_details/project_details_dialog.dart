...
import 'package:my_portfolio/ui/dialogs/project_details/project_details_dialog_model.dart';
import 'package:my_portfolio/ui/shared_widgets/rounded_icon_btn.dart';
import 'package:my_portfolio/ui/shared_widgets/skill_widget.dart';
              ...
              Wrap(
                ...
                children: [
                  viewModel.selectedProject.projectGithubLink != ""
                      ? RoundedIconButton(
                          onbtnclicked: () => viewModel.openurl(
                              viewModel.selectedProject.projectGithubLink),
                          labeltxt: "See On Github",
